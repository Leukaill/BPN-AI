    ...
    <div className="w-80 sidebar-glass dark:bg-slate-900/50 flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 border-b border-white/10">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-denyse-black dark:text-white flex items-center">
            <Brain className="text-denyse-turquoise mr-3" />
            Denyse
          </h1>
        ...
        <Button
          onClick={onNewChat}
          className="w-full liquid-glass-strong rounded-xl p-4 text-denyse-black dark:text-white hover:bg-white/40 transition-all duration-300 group ripple-effect"
          variant="ghost"
        >
          <div className="flex items-center justify-center space-x-2">
            <Plus className="text-denyse-turquoise group-hover:rotate-180 transition-transform duration-300" />
      ...
      <div className="flex-1 relative z-10">
        <ScrollArea className="h-full">
          <div className="p-6">
            <h2 className="text-lg font-semibold text-denyse-black dark:text-white mb-4 flex items-center">
              <History className="text-denyse-turquoise mr-2" />
              Recent
            </h2>
                    ...
                    <div className="flex items-start space-x-3">
                      <div className="flex-shrink-0 mt-1">
                        {chat.title.toLowerCase().includes("pdf") ? (
                          ...
                          <Globe className="w-4 h-4 text-denyse-green" />
                        ) : (
                          <BarChart className="w-4 h-4 text-denyse-turquoise" />
                        )}
                      </div>
